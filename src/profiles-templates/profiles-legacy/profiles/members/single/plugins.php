 ...
 */
		 ...
		 * @since 1.2.0
		 */
		do_action( 'profiles_before_member_plugin_template' ); ?>

		<?php if ( ! profiles_is_current_component_core() ) : ?>
		...
		<div class="item-list-tabs no-ajax" id="subnav">
			<ul>
				 ...
				 * @since 1.2.2
				 */
				do_action( 'profiles_member_plugin_options_nav' ); ?>
			</ul>
		</div><!-- .item-list-tabs -->

		<?php endif; ?>

		<?php if ( has_action( 'profiles_template_title' ) ) : ?>
			<h3><?php
			 ...
			 * @since 1.0.0
			 */
			do_action( 'profiles_template_title' ); ?></h3>
		 ...
		 * @since 1.0.0
		 */
		do_action( 'profiles_template_content' ); ?>
		 ...
		 * @since 1.2.0
		 */
		do_action( 'profiles_after_member_plugin_template' ); ?>
