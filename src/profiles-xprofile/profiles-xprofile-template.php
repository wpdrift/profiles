 ...
 *
 * @package Profiles
 * @suprofilesackage XProfileTemplate
 * @since 1.5.0
 */
...
if ( ! profiles()->do_autoload ) {
	require dirname( __FILE__ ) . '/classes/class-profiles-xprofile-data-template.php';
}
 ...
 * @see Profiles_XProfile_Group::get() for full description of `$args` array.
 *
 * @param array|string $args {
 *     Array of arguments. See Profiles_XProfile_Group::get() for full description. Those arguments whose defaults differ
 ...
 * @return bool
 */
function profiles_has_profile( $args = '' ) {
	...
	$hide_empty_fields_default = ( ! is_network_admin() && ! is_admin() && ! profiles_is_user_profile_edit() && ! profiles_is_register_page() );

	// We only need to fetch visibility levels when viewing your own profile.
	if ( profiles_is_my_profile() || profiles_current_user_can( 'profiles_moderate' ) || profiles_is_register_page() ) {
	...
	$profile_template = new Profiles_XProfile_Data_Template( $r );
	 ...
	 * @param array  $r                Array of arguments passed into the Profiles_XProfile_Data_Template class.
	 */
	return apply_filters( 'profiles_has_profile', $profile_template->has_groups(), $profile_template, $r );
}
 ...
 * @return mixed
 */
function profiles_profile_groups() {
	global $profile_template;
 ...
 * @return mixed
 */
function profiles_the_profile_group() {
	global $profile_template;
 ...
 * @return mixed
 */
function profiles_profile_group_has_fields() {
	global $profile_template;
 ...
 */
function profiles_field_css_class( $class = false ) {
	echo profiles_get_field_css_class( $class );
}
	 ...
	 * @return string
	 */
	function profiles_get_field_css_class( $class = false ) {
		global $profile_template;
		...
		$css_classes[] = 'visibility-' . esc_attr( profiles_get_the_profile_field_visibility_level() );
		 ...
		 */
		$css_classes = apply_filters_ref_array( 'profiles_field_css_classes', array( &$css_classes ) );
		 ...
		 */
		return apply_filters( 'profiles_get_field_css_class', ' class="' . implode( ' ', $css_classes ) . '"' );
	}
 ...
 * @return mixed
 */
function profiles_field_has_data() {
	global $profile_template;
 ...
 * @return bool
 */
function profiles_field_has_public_data() {
	global $profile_template;
 ...
 * @since 1.0.0
 */
function profiles_the_profile_group_id() {
	echo profiles_get_the_profile_group_id();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_group_id() {
		global $group;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_group_id', $group->id );
	}
 ...
 * @since 1.0.0
 */
function profiles_the_profile_group_name() {
	echo profiles_get_the_profile_group_name();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_group_name() {
		global $group;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_group_name', $group->name );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_group_slug() {
	echo profiles_get_the_profile_group_slug();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_group_slug() {
		global $group;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_group_slug', sanitize_title( $group->name ) );
	}
 ...
 * @since 1.0.0
 */
function profiles_the_profile_group_description() {
	echo profiles_get_the_profile_group_description();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_group_description() {
		global $group;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_group_description', $group->description );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_group_edit_form_action() {
	echo profiles_get_the_profile_group_edit_form_action();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_group_edit_form_action() {
		global $group;

		// Build the form action URL.
		$form_action = trailingslashit( profiles_displayed_user_domain() . profiles_get_profile_slug() . '/edit/group/' . $group->id );
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_group_edit_form_action', $form_action );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_group_field_ids() {
	echo profiles_get_the_profile_group_field_ids();
}
	 ...
	 * @return string
	 */
	function profiles_get_the_profile_group_field_ids() {
		global $group;
 ...
 * @since 2.1.0
 */
function profiles_the_profile_field_ids() {
	echo profiles_get_the_profile_field_ids();
}
	/**
	 ...
	 * @return string
	 */
	function profiles_get_the_profile_field_ids() {
		global $profile_template;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_ids', $field_ids );
	}
 ...
 * @return mixed
 */
function profiles_profile_fields() {
	global $profile_template;
 ...
 * @return mixed
 */
function profiles_the_profile_field() {
	global $profile_template;
 ...
 * @since 1.1.0
 */
function profiles_the_profile_field_id() {
	echo profiles_get_the_profile_field_id();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_id() {
		global $field;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_id', $field->id );
	}
 ...
 * @since 1.0.0
 */
function profiles_the_profile_field_name() {
	echo profiles_get_the_profile_field_name();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_name() {
		global $field;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_name', $field->name );
	}
 ...
 * @since 1.0.0
 */
function profiles_the_profile_field_value() {
	echo profiles_get_the_profile_field_value();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_value() {
		global $field;

		$field->data->value = profiles_unserialize_profile_field( $field->data->value );
		 ...
		 * @param int    $id    ID for the profile field.
		 */
		return apply_filters( 'profiles_get_the_profile_field_value', $field->data->value, $field->type, $field->id );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_field_edit_value() {
	echo profiles_get_the_profile_field_edit_value();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_edit_value() {
		global $field;
		...
		$field_value = isset( $field->data->value ) ? profiles_unserialize_profile_field( $field->data->value ) : '';
		 ...
		 * @param int    $id          ID for the profile field.
		 */
		return apply_filters( 'profiles_get_the_profile_field_edit_value', $field_value, $field->type, $field->id );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_field_type() {
	echo profiles_get_the_profile_field_type();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_type() {
		global $field;
		 ...
		 * @param string $type Type for the profile field.
		 */
		return apply_filters( 'profiles_the_profile_field_type', $field->type );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_field_description() {
	echo profiles_get_the_profile_field_description();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_description() {
		global $field;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_description', $field->description );
	}
 ...
 * @since 1.1.0
 */
function profiles_the_profile_field_input_name() {
	echo profiles_get_the_profile_field_input_name();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_input_name() {
		global $field;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_input_name', 'field_' . $field->id );
	}
 ...
 * object and rendered at actions that look like 'profiles_field_12_errors'. This
 ...
 */
function profiles_get_the_profile_field_errors_action() {
	global $field;
	return 'profiles_field_' . $field->id . '_errors';
}
 ...
 */
function profiles_the_profile_field_options( $args = array() ) {
	echo profiles_get_the_profile_field_options( $args );
}
	/**
	 ...
	 */
	function profiles_get_the_profile_field_options( $args = array() ) {
		global $field;
		...
		/**
		 * In some cases, the $field global is not an instantiation of the Profiles_XProfile_Field class.
 ...
 * @since 1.1.0
 */
function profiles_the_profile_field_is_required() {
	echo profiles_get_the_profile_field_is_required();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_is_required() {
		global $field;
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_is_required', (bool) $retval );
	}
 ...
 * @since 1.6.0
 */
function profiles_the_profile_field_visibility_level() {
	echo profiles_get_the_profile_field_visibility_level();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_visibility_level() {
		global $field;
		...
		if ( profiles_is_register_page() && ! empty( $_POST['field_' . $field->id . '_visibility'] ) ) {
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_visibility_level', $retval );
	}
 ...
 * @since 1.6.0
 */
function profiles_the_profile_field_visibility_level_label() {
	echo profiles_get_the_profile_field_visibility_level_label();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_the_profile_field_visibility_level_label() {
		global $field;
		...
		$fields = profiles_xprofile_get_visibility_levels();
		 ...
		 */
		return apply_filters( 'profiles_get_the_profile_field_visibility_level_label', $fields[ $level ]['label'], $level );
	}
 ...
 * @return mixed|string
 */
function profiles_unserialize_profile_field( $value ) {
 ...
 * @since 1.2.0
 *
 * @param string|array $args Array of arguments for field data. See {@link profiles_get_profile_field_data}
 */
function profiles_profile_field_data( $args = '' ) {
	echo profiles_get_profile_field_data( $args );
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_profile_field_data( $args = '' ) {
 ...
 * @return array $groups
 */
function profiles_profile_get_field_groups() {

	$groups = wp_cache_get( 'all', 'profiles_xprofile_groups' );
	if ( false === $groups ) {
		$groups = profiles_xprofile_get_groups( array( 'fetch_fields' => true ) );
		wp_cache_set( 'all', $groups, 'profiles_xprofile_groups' );
	}
	 ...
	 */
	return apply_filters( 'profiles_profile_get_field_groups', $groups );
}
 ...
 */
function profiles_profile_has_multiple_groups() {
	$has_multiple_groups = count( (array) profiles_profile_get_field_groups() ) > 1;
	 ...
	 */
	return (bool) apply_filters( 'profiles_profile_has_multiple_groups', $has_multiple_groups );
}
 ...
 * @since 1.0.0
 */
function profiles_profile_group_tabs() {
	echo profiles_get_profile_group_tabs();
 ...
 * @return string
 */
function profiles_get_profile_group_tabs() {

	// Get field group data.
	$groups     = profiles_profile_get_field_groups();
	$group_name = profiles_get_profile_group_name();
	$tabs       = array();
	...
	for ( $i = 0, $count = count( $groups ); $i < $count; ++$i ) {
		...
		$link   = trailingslashit( profiles_displayed_user_domain() . profiles_get_profile_slug() . '/edit/group/' . $groups[ $i ]->id );
		...
		$tabs[] = sprintf(
			...
			$selected,
			esc_url( $link ),
			esc_html( apply_filters( 'profiles_get_the_profile_group_name', $groups[ $i ]->name ) )
		);
	}
 ...
 * @return mixed|void
 */
function profiles_profile_group_name( $deprecated = true ) {
	if ( !$deprecated ) {
		return profiles_get_profile_group_name();
	} else {
		echo profiles_get_profile_group_name();
	}
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_profile_group_name() {

		// Check action variable.
		$group_id = profiles_action_variable( 1 );
		 ...
		 */
		return apply_filters( 'profiles_get_profile_group_name', $group->name, $group_id );
	}
 ...
 * @since 1.0.0
 */
function profiles_profile_last_updated() {

	$last_updated = profiles_get_profile_last_updated();

	if ( empty( $last_updated ) ) {
		_e( 'Profile not recently updated.', 'profiles' );
	} else {
		echo $last_updated;
	}
}
	 ...
	 */
	function profiles_get_profile_last_updated() {

		$last_updated = profiles_get_user_meta( profiles_displayed_user_id(), 'profile_last_updated', true );
		...
		if ( ! empty( $last_updated ) ) {
			 ...
			 */
			return apply_filters( 'profiles_get_profile_last_updated', sprintf( __( 'Profile updated %s', 'profiles' ), profiles_core_time_since( strtotime( $last_updated ) ) ) );
		}
 ...
 * @since 1.1.0
 */
function profiles_current_profile_group_id() {
	echo profiles_get_current_profile_group_id();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_current_profile_group_id() {
		$profile_group_id = profiles_action_variable( 1 );
		 ...
		 */
		return apply_filters( 'profiles_get_current_profile_group_id', $profile_group_id );
	}
 ...
 * @since 1.1.0
 */
function profiles_avatar_delete_link() {
	echo profiles_get_avatar_delete_link();
}
	 ...
	 * @return mixed|void
	 */
	function profiles_get_avatar_delete_link() {
		 ...
		 */
		return apply_filters( 'profiles_get_avatar_delete_link', wp_nonce_url( profiles_displayed_user_domain() . profiles_get_profile_slug() . '/change-avatar/delete-avatar/', 'profiles_delete_avatar_link' ) );
	}
 ...
 * @since 1.0.0
 */
function profiles_edit_profile_button() {
	profiles_button( array(
		'id'                => 'edit_profile',
		'component'         => 'xprofile',
		'must_be_logged_in' => true,
		'block_self'        => true,
		'link_href'         => trailingslashit( profiles_displayed_user_domain() . profiles_get_profile_slug() . '/edit' ),
		'link_class'        => 'edit',
		'link_text'         => __( 'Edit Profile', 'profiles' ),
	) );
}
 ...
 * @since 1.6.0
 *
 * @param array|string $args Args for the radio buttons. See {@link profiles_profile_get_visibility_radio_buttons}
 */
function profiles_profile_visibility_radio_buttons( $args = '' ) {
	echo profiles_profile_get_visibility_radio_buttons( $args );
}
	/**
	 ...
	 */
	function profiles_profile_get_visibility_radio_buttons( $args = '' ) {
		...
		$r = profiles_parse_args( $args, array(
			...
			'after_radio'  => '</li>',
			'class'        => 'profiles-xprofile-visibility'
		...
		if ( ! empty( $r['field_id'] ) ) :
			...
			<?php if ( profiles_current_user_can( 'profiles_xprofile_change_field_visibility' ) ) : ?>
				...
				<?php foreach( profiles_xprofile_get_visibility_levels() as $level ) : ?>

					<?php printf( $r['before_radio'], esc_attr( $level['id'] ) ); ?>

					<label for="<?php echo esc_attr( 'see-field_' . $r['field_id'] . '_' . $level['id'] ); ?>">
						<input type="radio" id="<?php echo esc_attr( 'see-field_' . $r['field_id'] . '_' . $level['id'] ); ?>" name="<?php echo esc_attr( 'field_' . $r['field_id'] . '_visibility' ); ?>" value="<?php echo esc_attr( $level['id'] ); ?>" <?php checked( $level['id'], profiles_get_the_profile_field_visibility_level() ); ?> />
		 ...
		 */
		return apply_filters( 'profiles_profile_get_visibility_radio_buttons', $retval, $r, $args );
	}
 ...
 * @since 2.0.0
 *
 * @param array|string $args Args for the select list. See {@link profiles_profile_get_settings_visibility_select}
 */
function profiles_profile_settings_visibility_select( $args = '' ) {
	echo profiles_profile_get_settings_visibility_select( $args );
}
	/**
	 ...
	 * @return string $retval
	 */
	function profiles_profile_get_settings_visibility_select( $args = '' ) {
		...
		if ( ! empty( $r['field_id'] ) ) :
			...
			<?php if ( profiles_current_user_can( 'profiles_xprofile_change_field_visibility' ) ) : ?>
				...
				<label for="<?php echo esc_attr( 'field_' . $r['field_id'] ) ; ?>_visibility" class="profiles-screen-reader-text"><?php
					/* translators: accessibility text */
					_e( 'Select visibility', 'profiles' );
				?></label>
				<select class="<?php echo esc_attr( $r['class'] ); ?>" name="<?php echo esc_attr( 'field_' . $r['field_id'] ) ; ?>_visibility" id="<?php echo esc_attr( 'field_' . $r['field_id'] ) ; ?>_visibility">
					...
					<?php foreach ( profiles_xprofile_get_visibility_levels() as $level ) : ?>
						...
						<option value="<?php echo esc_attr( $level['id'] ); ?>" <?php selected( $level['id'], profiles_get_the_profile_field_visibility_level() ); ?>><?php echo esc_html( $level['label'] ); ?></option>
			...
			<?php else : ?>
				...
				<span class="field-visibility-settings-notoggle"><?php profiles_the_profile_field_visibility_level_label(); ?></span>
		 ...
		 * @param array  $args   Original passed in arguments to be used with display.
		 */
		return apply_filters( 'profiles_profile_settings_visibility_select', $retval, $r, $args );
	}
 ...
 * @since 2.4.0
 */
function profiles_the_profile_field_required_label() {
	echo profiles_get_the_profile_field_required_label();
}
	 ...
	 */
	function profiles_get_the_profile_field_required_label() {
		$retval = '';

		if ( profiles_get_the_profile_field_is_required() ) {
			$translated_string = __( '(required)', 'profiles' );

			$retval = ' <span class="profiles-required-field-label">';
			$retval .= apply_filters( 'profiles_get_the_profile_field_required_label', $translated_string, profiles_get_the_profile_field_id() );
			$retval .= '</span>';
