 ...
 * @since 1.7.0
 */
class Profiles_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		 ...
		 */
		$class_names = join( ' ', apply_filters( 'profiles_nav_menu_css_class', array_filter( $item->class ), $item, $args ) );
		 ...
		 * @param array  $args Array of arguments for the item.
		 */
		$id = apply_filters( 'profiles_nav_menu_item_id', $id, $item, $args );
		 ...
		 * @param array  $args        Array of arguments for the item.
		 */
		$output .= apply_filters( 'profiles_walker_nav_menu_start_el', $item_output, $item, $depth, $args );
	}
}
