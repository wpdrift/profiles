 ...
 * @since 1.0.3
 */
class Profiles_Core_Recently_Active_Widget extends WP_Widget {
	...
	public function __construct() {
		$name        = _x( '(Profiles) Recently Active Members', 'widget name', 'profiles' );
		$description = __( 'Profile photos of recently active members', 'profiles' );
		parent::__construct( false, $name, array(
			'description'                 => $description,
			'classname'                   => 'widget_profiles_core_recently_active_widget profiles widget',
	...
	public function widget( $args, $instance ) {
		...
		<?php else: ?>
			...
			<div class="widget-error">
				<?php esc_html_e( 'There are no recently active members', 'profiles' ); ?>
			</div>
	...
	public function parse_settings( $instance = array() ) {
		return profiles_parse_args( $instance, array(
			'title' 	     => __( 'Recently Active Members', 'profiles' ),
			'max_members' 	 => 15,
