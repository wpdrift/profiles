<?php
/**
 * Backward compatibility for the $profiles->profiles_options_nav global.
 *
 * @since 2.6.0
 */
...
/**
 * profiles_options_nav backward compatibility class.
 *
 * This class is used to provide backward compatibility for extensions that access and modify
 * the $profiles->profiles_options_nav global.
 *
 * @since 2.6.0
 */
class Profiles_Core_Profiles_Options_Nav_BackCompat extends Profiles_Core_Profiles_Nav_BackCompat {
	/**
	...
	public function offsetGet( $offset ) {
		_doing_it_wrong(
			'profiles_nav',
			__( 'These globals should not be used directly and are deprecated. Please use the Profiles nav functions instead.', 'profiles' ),
			'2.6.0'
		);
