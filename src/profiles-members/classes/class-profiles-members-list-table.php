<?php
/**
 * Profiles Members List Table class.
 *
 * @package Profiles
 ...
 * @since 2.0.0
 */
class Profiles_Members_List_Table extends WP_Users_List_Table {
	...
	public function get_columns() {
		 ...
		 */
		return apply_filters( 'profiles_members_signup_columns', array(
	...
	public function column_username( $signup_object = null ) {
		...
		$email_link = add_query_arg(
			...
			profiles_get_admin_url( 'users.php' )
		);
	...
	function column_default( $signup_object = null, $column_name = '' ) {
		 ...
		 * @param object $signup_object The signup data object.
		 */
		return apply_filters( 'profiles_members_signup_custom_column', '', $column_name, $signup_object );
	}
}
