 ...
 * @since 2.0.0
 */
class Profiles_XProfile_Field_Type_Radiobutton extends Profiles_XProfile_Field_Type {
	...
	public function __construct() {
		...
		/**
		 * Fires inside __construct() method for Profiles_XProfile_Field_Type_Radiobutton class.
		 *
		 * @since 2.0.0
		 *
		 * @param Profiles_XProfile_Field_Type_Radiobutton $this Current instance of
		 *                                                 the field type radio button.
		 */
		do_action( 'profiles_xprofile_field_type_radiobutton', $this );
	}
	...
	public function edit_field_options_html( array $args = array() ) {
		$option_value = Profiles_XProfile_ProfileData::get_value_byid( $this->field_obj->id, $args['user_id'] );
		...
		for ( $k = 0, $count = count( $options ); $k < $count; ++$k ) {
			 ...
			 */
			$html .= apply_filters( 'profiles_get_the_profile_field_options_radio', $new_html, $options[$k], $this->field_obj->id, $selected, $k );
		}
	...
	public function admin_field_html( array $raw_properties = array() ) {
		profiles_the_profile_field_options();
