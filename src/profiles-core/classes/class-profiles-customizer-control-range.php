 ...
 * @since 2.5.0
 */
class Profiles_Customizer_Control_Range extends WP_Customize_Control {
	/**
	 * @var string
	 */
	public $type = 'range';
	...
	public function enqueue() {
		wp_enqueue_script( 'profiles-customizer-controls' );
		wp_enqueue_style( 'profiles-customizer-controls' );
	}
