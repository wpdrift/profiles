 ...
 * @since 2.2.0
 */
abstract class Profiles_Recursive_Query {
	 ...
	 * For example, {@link Profiles_XProfile_Query::get_sql()} is merely a wrapper for
	 * get_sql_clauses(), while {@link Profiles_Activity_Query::get_sql()} discards
