...
<script id="tmpl-bp-cover-image-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-cover-image" href="#"><?php esc_html_e( 'Delete My Cover Image', 'profiles' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-cover-image" href="#"><?php esc_html_e( 'Delete Group Cover Image', 'profiles' ); ?></a></p>
	<# } else { #>
