 ...
 * for future Theme Packs to use. {@link Profiles_Legacy} is a good example of
 * extending this class.
 *
 * @since 1.7.0
 *
 * @todo We should probably do something similar to Profiles_Component::start().
...
class Profiles_Theme_Compat {
	 ...
	 * @since 1.7.0
	 *
	 * @param array $properties Array of properties for Profiles_Theme_Compat.
	 */
	 ...
	 * {@link Profiles_Legacy::setup_globals()} for an example.
	 *
	 * @since 1.7.0
	 */
	 ...
	 *
	 * Meant to be overridden in your class. See
	 * {@link Profiles_Legacy::setup_actions()} for an example.
	 *
	 * @since 1.7.0
	 */
