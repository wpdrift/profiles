 ...
 * @since 2.1.0
 */
class Profiles_XProfile_Field_Type_URL extends Profiles_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( 'URL', 'xprofile field type', 'profiles' );
		...
		/**
		 * Fires inside __construct() method for Profiles_XProfile_Field_Type_URL class.
		 *
		 * @since 2.0.0
		 *
		 * @param Profiles_XProfile_Field_Type_URL $this Current instance of
		 *                                         the field type URL.
		 */
		do_action( 'profiles_xprofile_field_type_url', $this );
	}
	...
	public function edit_field_html( array $raw_properties = array() ) {
		...
		// fields types pass to {@link profiles_the_profile_field_options()}.
		...
		$r = profiles_parse_args( $raw_properties, array(
			'type'      => 'text',
			'inputmode' => 'url',
			'value'     => esc_url( profiles_get_the_profile_field_edit_value() ),
		) ); ?>
