...
class Profiles_XProfile_Query {
	 ...
	 *
	 * Called by the public {@see Profiles_XProfile_Query::get_sql()}, this method is abstracted out to maintain parity
	...
	public function get_sql_for_clause( &$clause, $parent_query ) {
		...
		if ( array_key_exists( 'value', $clause ) ) {
			...
			switch ( $field_compare ) {
				...
				case 'LIKE' :
				case 'NOT LIKE' :
					$field_value = '%' . profiles_esc_like( $field_value ) . '%';
	 ...
	 * operator and relation between the clauses allows for a shared table join. In the case of Profiles_XProfile_Query,
