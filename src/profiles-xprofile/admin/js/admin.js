...
function add_option(forWhat) {
	...
	newDiv.setAttribute('class', 'profiles-option sortable');

	grabber.setAttribute( 'class', 'profiles-option-icon grabber');
...
function enableSortableFieldOptions() {
	jQuery( '.profiles-options-box' ).sortable( {
		cursor: 'move',
		items: 'div.sortable',
		tolerance: 'intersect',
		axis: 'y'
...
function destroySortableFieldOptions() {
	jQuery( '.profiles-options-box' ).sortable( 'destroy' );
...
jQuery( document ).ready( function() {
	...
	jQuery( '#profiles-xprofile-add-field #title' ).focus();
