 ...
 * @since 2.5.0
 */
class Profiles_PHPMailer implements Profiles_Email_Delivery {
	...
	public function profiles_email( Profiles_Email $email ) {
		...
		$phpmailer->IsMail();
		$phpmailer->CharSet = profiles_get_option( 'blog_charset' );
		 ...
		 */
		do_action( 'profiles_phpmailer_init', $phpmailer );
