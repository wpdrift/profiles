 ...
 * @since 1.0.0
 */
class Profiles_XProfile_Data_Template {
	 ...
	 *
	 * @see Profiles_XProfile_Group::get() for more details about parameters.
	 *
	 * @since 1.5.0
	...
	public function __construct( $args = '' ) {
		...
		if ( ! is_array( $args ) || func_num_args() > 1 ) {
			_deprecated_argument( __METHOD__, '2.3.0', sprintf( __( 'Arguments passed to %1$s should be in an associative array. See the inline documentation at %2$s for more details.', 'profiles' ), __METHOD__, __FILE__ ) );
			...
			$args      = profiles_core_parse_args_array( $old_args_keys, $func_args );
		}
		...
		$this->groups      = profiles_xprofile_get_groups( $r );
