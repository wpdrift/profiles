 ...
 * @since 1.9.0
 */
class Profiles_Walker_Nav_Menu_Checklist extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( ! in_array( array( 'profiles-menu', 'profiles-'. $item->post_excerpt .'-nav' ), $item->classes ) ) {
			$item->classes[] = 'profiles-menu';
			$item->classes[] = 'profiles-'. $item->post_excerpt .'-nav';
		}
